...
data class CatchItem(
    ...
    val totalWeightPounds: Int?,        // Store Pounds 0.00 as total hundredths of Pounds
...
fun CatchItem.getMeasurementMode(): MeasurementMode? {
    return when {
        ...
        totalWeightPounds !=null -> MeasurementMode.POUNDS
...
fun CatchItem.getComparisonValueByMode(mode: MeasurementMode): Int {
    return when (mode) {
        ...
        MeasurementMode.POUNDS -> totalWeightPounds ?:0
